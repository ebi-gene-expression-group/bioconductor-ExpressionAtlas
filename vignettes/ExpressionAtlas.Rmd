...
author: "Maria Keays, Pedro Madrigal, Anil Thanki, Iris Yu"
...
```{r eval=FALSE}
mtab3007 <- volcanoDifferentialAtlasExperiment( mtab10104_dea )
# Downloading expression file from:
#  ftp://ftp.ebi.ac.uk/pub/databases/microarray/data/atlas/experiments/E-MTAB-10104/E-MTAB-10104-tpm.tsv
# Successfully downloaded expression data for E-MTAB-3007
```

```{r eval=FALSE}
mtab3007 <- volcanoDifferentialAtlasExperiment( mtab10104_dea, "E-MTAB-10104", "Gray", "Blue", 1, TRUE )
# Downloading expression file from:
#  ftp://ftp.ebi.ac.uk/pub/databases/microarray/data/atlas/experiments/E-MTAB-10104/E-MTAB-10104-tpm.tsv
# Successfully downloaded expression data for E-MTAB-3007
```
