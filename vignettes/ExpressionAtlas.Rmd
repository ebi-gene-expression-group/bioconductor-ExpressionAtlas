...
mtab4045_tpm <- getNormalisedAtlasExpression( "E-MTAB-4045", "tpm" ) 
mtab4045 <- heatmapAtlasExperiment( mtab4045_tpm, "E-MTAB-4045-tpm-heatmap.pdf", FALSE, TRUE,  "Blues", 20, TRUE )
```

And now using CPM data, instead of TPM:
```{r eval=TRUE, fig.width=7, fig.height=6}
mtab4045_cpm <- getNormalisedAtlasExpression( "E-MTAB-4045", "cpm" ) 
mtab4045 <- heatmapAtlasExperiment( mtab4045_cpm, "E-MTAB-4045-cpm-heatmap.pdf", FALSE, TRUE,  "Blues", 20, TRUE )
```
